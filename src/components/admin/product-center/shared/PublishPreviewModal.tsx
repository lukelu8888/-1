    ...
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="!max-w-5xl !p-0">
        <div className="flex items-center justify-between gap-2 border-b border-slate-200 bg-slate-50 px-4 py-2.5">
          <div>
            <DialogTitle className="text-[14px]">发布预览 · Publish Preview</DialogTitle>
        ...
        <div className="grid grid-cols-12 gap-0">
          {/* Mock browser chrome */}
          <div className="col-span-12 border-b border-slate-200 bg-white px-3 py-1.5">
            <div className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-slate-50 px-2 py-0.5 font-mono text-[11px] text-slate-500">
              <Globe className="h-3 w-3" /> https://cosun.com/{r.code.toLowerCase()}/p/{seoSlug}
            </div>
          </div>
          ...
          <div className="col-span-7 space-y-2 p-4">
            {hero ? (
              ...
              <div className="flex aspect-square w-full items-center justify-center rounded border border-dashed border-slate-300 bg-slate-50 text-slate-400">
          ...
          {/* PDP detail */}
          <div className="col-span-5 space-y-3 border-l border-slate-200 p-4">
            {/* status & breadcrumb */}
          ...
          {/* SEO panel */}
          <div className="col-span-12 border-t border-slate-200 bg-slate-50 p-4">
            <div className="mb-2 text-[11px] font-semibold uppercase tracking-wide text-slate-500">
              SEO meta · Region {region}
            </div>
            <div className="rounded border border-slate-200 bg-white p-3 text-[12px]">
              <div className="text-[14px] text-blue-700">{seoTitle}</div>
        ...
        <DialogFooter className="border-t border-slate-200 px-4 py-2">
