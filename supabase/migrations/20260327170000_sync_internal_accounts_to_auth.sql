...
drop trigger if exists trg_sync_admin_internal_accounts_to_auth on public.admin_organizations;

create trigger trg_sync_admin_internal_accounts_to_auth
before insert or update of internal_contacts, internal_accounts
on public.admin_organizations
for each row
execute function public.sync_admin_internal_accounts_to_auth();
